...
You can install `ndev-batch` via [pip]:

```
pip install ndev-batch
```

If napari is not already installed, you can install `ndev-batch` with napari and Qt via:

```
pip install "ndev-batch[all]"
```
...
```
pip install git+https://github.com/ndev-kit/ndev-batch.git
```
...
"ndev-batch" is free and open source software
...
[file an issue]: https://github.com/ndev-kit/ndev-batch/issues
